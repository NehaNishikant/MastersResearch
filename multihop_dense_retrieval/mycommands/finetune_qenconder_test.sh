...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python scripts/train_momentum.py \
    ...
    --learning_rate 1e-5 \
    --fp16 \
    --train_file /home/nnishika/multihop_dense_retrieval/data/hotpot/hotpot_train_with_neg_v0.json \
    --predict_file /home/nnishika/multihop_dense_retrieval/data/hotpot/hotpot_dev_with_neg_v0.json \
    --seed 16 \
    --eval-period -1 \
    --max_c_len 300 \
    --max_q_len 70 \
