...
scripts/encode_corpus.py \
    ...
    --predict_file /projects/tir3/users/nnishika/stqa_corpus_chunks/stqa_corpus_69.json \
    --init_checkpoint /home/nnishika/multihop_dense_retrieval/models/doc_encoder.pt \
    --embed_save_path /projects/tir3/users/nnishika/StqaIndexChunks/StqaIndexChunk69 \
    --fp16 \
    --max_c_len 300 \
    --num_workers 20
    # --local_rank 0
