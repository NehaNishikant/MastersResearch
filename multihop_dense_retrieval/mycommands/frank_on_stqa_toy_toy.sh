...
# --mem=256gb --gres=gpu:1

python scripts/eval/eval_frankenstein.py /home/nnishika/strategyqa/data/strategyqa/dev_toy_toy.json \
    ...
    --save-path /home/nnishika/mdrout/frank_stqa_retrieval_toy_toy.json
#   --gpu
